...
document.addEventListener('DOMContentLoaded', (): void => {
    ...
    let mandelbulbShader: WebGLProgram;
    const Init = (): void => {
        ...
        const CreateShader = (source: string, type: number): WebGLShader => {
            const shader = gl.createShader(type) as WebGLShader; // TODO: do a null check
        ...
        mandelbulbShader = gl.createProgram() as WebGLProgram; // TODO: do a null check
        ...
        if (!(gl.getProgramParameter(mandelbulbShader, gl.LINK_STATUS) as boolean)) {
